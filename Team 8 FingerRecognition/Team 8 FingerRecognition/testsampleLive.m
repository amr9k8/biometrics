function [ matchedperson,res,matching_score] = testsample( sample_test )
...
test_mean=mean(matching_score);
[res,matchedperson]=max(matching_score);
if(mean(matching_score)<5)
    matchedperson=0;
end
